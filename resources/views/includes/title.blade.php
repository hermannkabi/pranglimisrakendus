...
<<<<<<< Updated upstream
    <a href="{{ route("valimised.dashboard") }}" style="all:unset; cursor: pointer;"><h1 style="font-weight: normal; margin-bottom: 0;">Rebaste nädal 2024</h1></a>
    ...
    <div style="border-radius: 4px; color: #3C72FF; background-color: transparent; border: 1px solid #3C72FF; width: min(344px, calc(100% - 16px)); padding: 8px; display: flex; flex-direction: column; align-items: start; gap: 8px">
        <i style="font-size: 16px" class="material-icons">info</i>
