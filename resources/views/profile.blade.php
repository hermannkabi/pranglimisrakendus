...
<body>
    ...
    <div style="margin-inline: var(--margin-inline); font-size: 24px">
        ...
        <p style="word-wrap: anywhere">Konto tüüp: {{ str_contains(Auth::user()->role, "valimised-admin") ? "Admin" : "Tavakonto"}} <a style="text-decoration: none; color: #3C72FF" href="{{route('valimised.apply')}}">(taotlused)</a></p>
        @if (count($fox) >= 1)
