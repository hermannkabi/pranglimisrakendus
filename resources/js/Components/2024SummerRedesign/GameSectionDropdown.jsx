    ...
    return <>
        <div>
            ...
            <div ref={collapsibleRef}>
                <SizedBox height="8px" />
                <div >
                    {gameTypes.map((e)=><a key={e} href={e in links ? links[e] : "/preview/"+e} style={{all:"unset", cursor:"pointer", display:"block", marginBlock:"6px", textAlign:"left", marginLeft:"16px"}}>{getGameName(e)}</a>)}
                </div>
            </div>
