    ...
    return  <div style={{flex:"1", textAlign:"center"}}>
                ...
                <a style={{all:"unset"}} href={"/profile/"+e.user.id}>
                    <div style={{marginBlock:window.innerWidth < 600 ? "0" : null}} className="section clickable">
                        ...
                        {!firstPlace && <p style={{textTransform:"capitalize", marginBlock:"4px", display:"inline-flex", alignItems:'center', gap:"4px", fontWeight:auth.user.id == e.user.id ? "bold" : null, color: auth.user.id == e.user.id ? "rgb(var(--primary-color))" : null}}>{e.user.eesnimi} {e.user.perenimi} {e.playedToday && <StreakActiveWidget />} </p>}
