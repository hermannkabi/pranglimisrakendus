...
export default function leaderboardRow({place, points, index, player, user, playedToday=false, onRemove=null}){
    ...
    return (
        <a style={{all:"unset", cursor:"pointer"}} href={onRemove ? null : "/profile/"+user.id}>
