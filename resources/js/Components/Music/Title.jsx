...
export default function Title({title, showBack=true, thumbnail=null}){
   ...
   return <>
        <div style={{display:"flex", flexDirection:"column", gap:"8px", alignItems:"start", margin:"16px 24px"}}>
                ...
                <div className="title-container" style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"16px"}}>
