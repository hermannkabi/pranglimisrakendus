export default function RadioChoice({icon, text, selected, onClick}){
    return (
        <div className="radio-choice" onClick={onClick} style={{border:"2px solid rgb(var(--primary-color))", borderRadius:"8px", display:"inline-flex", marginInline:"4px"}}>
            ...
            <p style={{padding:"4px 16px", userSelect:"none"}}>{text}</p>
        </div>
    );
}