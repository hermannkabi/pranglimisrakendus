export default function StatisticsWidget({stat, desc, oneDesc=null, condensed=false}){
    return (
        <div className="stat-widget" style={{display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", margin:"4px", backgroundColor: "rgb(var(--section-color), var(--section-transparency))", borderRadius:"var(--primary-btn-border-radius)"}}>
            <h3 style={{color:"rgb(var(--primary-color))", marginTop:"16px", margin:"8px", fontSize: condensed ? "1.2rem" : "1.8rem", fontFamily: condensed ? "Lexend Zetta" : "Lexend Zetta", fontWeight:"bold"}}>{stat}</h3>
